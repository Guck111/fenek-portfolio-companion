...
const DENIAL_TEXTS: Readonly<Record<ProDenialReason, string>> = {
  ...
  unreachable: `Fenek could not validate the Pro license within the 14-day grace period (the license server was unreachable). This is not a billing decision — access resumes automatically once validation succeeds. Classic-broker and portfolio tools keep working.`,
}
